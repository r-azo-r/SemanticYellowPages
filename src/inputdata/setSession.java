...
public class setSession extends HttpServlet {
	...
	ArrayList<Company> acl=new Search().retrieveCompanyInformation(k);
	session.setAttribute("companyinfo",acl);
	k=k.toLowerCase();
	String temp=k.replaceAll(" ","_");
	ArrayList<Information> atl=new FreeBase().start(temp,"KshitijShah");
