...
public class web2onto {
	public static void addUserData(UserProfile profile)
	{
		...
		InputStream stream = FileManager.get().open("C:\\Users\\Kshitij\\helios workspace\\WebApp2\\WebContent\\UserData.owl");
        ...
        OntClass movies = model.getOntClass(uri+"Movies");
	  	...
	  	RDFWriter writer = model.getWriter("RDF/XML");
		   ...
		   OutputStream out = new FileOutputStream("C:\\Users\\Kshitij\\helios workspace\\WebApp2\\WebContent\\UserData.owl");
...
public static void PoplateServiceModel(Company company)
	{
		...
		InputStream stream = FileManager.get().open("C:\\Users\\Kshitij\\helios workspace\\WebApp2\\WebContent\\ServiceData.owl");
		...
		for(int i = 0 ;i<stores.length;i++)
		{
		   ...
		   OutputStream out = new FileOutputStream("C:\\Users\\Kshitij\\helios workspace\\WebApp2\\WebContent\\ServiceData.owl");
